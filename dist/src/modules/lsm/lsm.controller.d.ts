...
export declare class LsmController {
    ...
    getDisputes(userId: number, status?: string, page?: string, limit?: string): Promise<{
        data: {
            id: number;
            job: {
                id: number;
    ...
    getJobsInRegion(userId: number, status?: string, providerId?: string, fromDate?: string, toDate?: string, page?: string, limit?: string): Promise<{
        data: {
            id: number;
            service: string;
            category: string;
    ...
    getServiceRequestsHistory(userId: number, status?: string, page?: string, limit?: string): Promise<{
        data: {
            id: number;
            serviceName: string;
            category: string;
